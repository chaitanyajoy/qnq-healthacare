...
const slider_content = [
  {
    ...
    des: "QnQ Healthcare undergoes drug quality testing of all batches of medicines (Active Pharmaceutical Ingredient assay & quantity, etc.) in a reputable NABL accredited third-party drug testing laboratory",
    color_icon: "",
    color: "",
  },
  {
    ...
    des: "Trust in our high-quality pediatric products to keep your child happy and healthy. From vitamins to skincare, we offer a wide range of items to support your child's growth and development.",
  ...
  },
  {
    ...
    title: "FMCGS",
    des: "At our pharmacies, you can find a range of FMCG products, including personal care items, health supplements, and more. Pair with us for convenient and affordable solutions for your everyday needs.",
  ...
  },
  {
    ...
    icon: "flaticon-dna-1",
    title: "OTCS",
    des: "Our pharmacy offers a variety of OTC products to help with common ailments such as headaches, colds, and allergies. Visit us today for expert advice and quality OTC medicines.",
    color_icon: "sky-icon",
    color: "sky-hexa",
  },
];
          ...
          <div className="row align-items-center">
            <div className="col-lg-8 col-md-8 col-12">
              <div className="tp-section">
                ...
                <h3 className="tp-section__title mb-50">Products</h3>
              </div>
            </div>
