...
const hero_slider = [
  {
    ...
    title: (
      <>
        Welcome! <br /> Pharma <br /> Companies
      </>
    ),
    des: (
      <>
        Your only source warehouse for pharma stocks. Our mission is to ensure the{" "}
        <br /> supply of qualified and affordable medicines
      </>
    ),
    appointment: "Customer",
    about: "Investor / Company",
