          ...
          <div className="container">
            <div className="row mb-40">
              <div className="col-lg-6 col-md-6">
                <div
                  ...
                  data-wow-delay=".2s"
                >
                  <h5 className="tpproject-title mb-50">3 Steps to get Your Franchise </h5>
                  <p>
                    sample step 1:<span> a representative at our company </span>
                  </p>
                  <p>
                    sample step 2:<span> a representative at our company </span>
                  </p>
                  <p>
                    sample step 3:<span> a representative at our company </span>
                  </p>
              ...
              <div className="col-lg-6 col-md-6">
                ...
                >
                  ...
                  For many business owners, our franchising strategy is an appealing one. As a franchisee, you gain access to the substantial company's resources, expertise, and support. By offering you a tested business concept, operational support, training, marketing tools, and access to current clients, this lowers the risk involved with beginning a business.
                  </p>
                  <p>
            ...
            <div className="row mr-100">
              ...
              <div className="col-lg-6 col-md-6">
                ...
                >
                  <p>
                  For many business owners, our franchising strategy is an appealing one. As a franchisee, you gain access to the substantial company's resources, expertise, and support. By offering you a tested business concept, operational support, training, marketing tools, and access to current clients, this lowers the risk involved with beginning a business.For many business owners, our franchising strategy is an appealing one. As a franchisee, you gain access to the substantial company's resources, expertise, and support. By offering you a tested business concept, operational support, training, marketing tools, and access to current clients, this lowers the risk involved with beginning a business.
                  </p>
                  <p>
                  For many business owners, our franchising strategy is an appealing one. As a franchisee, you gain access to the substantial company's resources, expertise, and support. By offering you a tested business concept, operational support, training, marketing tools, and access to current clients, this lowers the risk involved with beginning a business. For many business owners, our franchising strategy is an appealing one. As a franchisee, you gain access to the substantial company's resources, expertise, and support. By offering you a tested business concept, operational support, training, marketing tools, and access to current clients, this lowers the risk involved with beginning a business.
                  </p>
